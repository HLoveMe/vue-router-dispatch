(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("rxjs"), require("vue"));
	else if(typeof define === 'function' && define.amd)
		define(["rxjs", "vue"], factory);
	else if(typeof exports === 'object')
		exports["Pin"] = factory(require("rxjs"), require("vue"));
	else
		root["Pin"] = factory(root["rxjs"], root["vue"]);
})(self, (__WEBPACK_EXTERNAL_MODULE_rxjs__, __WEBPACK_EXTERNAL_MODULE_vue__) => {
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! rxjs */ "rxjs");
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/dist/esm5/internal/operators/takeLast.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/dist/esm5/internal/operators/filter.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/dist/esm5/internal/operators/bufferCount.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/dist/esm5/internal/operators/map.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/dist/esm5/internal/operators/take.js");
...
/* harmony import */ var _initParams__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./initParams */ "./dist/initParams.js");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! vue */ "vue");
...
var getCurrentServer = function getCurrentServer(current) {
  ...
  var id = (0,_initParams__WEBPACK_IMPORTED_MODULE_23__.PolySymbol)(fullPath);
  var server = _initParams__WEBPACK_IMPORTED_MODULE_23__.ServerMap.get(id);

  if (server) {
    result = server;
  } else {
    result.id = (0,_initParams__WEBPACK_IMPORTED_MODULE_23__.PolySymbol)(current.fullPath);
    result.route = current;
    result.children = [];
    result.clearSubs = [];
    result.channelCenter = new rxjs__WEBPACK_IMPORTED_MODULE_22__.BehaviorSubject(_initParams__WEBPACK_IMPORTED_MODULE_23__.initEvent);
  }
...
var currentServer = (0,vue__WEBPACK_IMPORTED_MODULE_24__.shallowRef)(_initParams__WEBPACK_IMPORTED_MODULE_23__.SHALL_CURRENT);
...
function _dispatch(tran, event) {
  ...
  var isRoot = id === _initParams__WEBPACK_IMPORTED_MODULE_23__.GlobalRServerKey;
  ...
  var resolve = event.resolve,
      reject = event.reject;
  var root = (0,rxjs__WEBPACK_IMPORTED_MODULE_22__.from)(new Promise(function (resolve, reject) {
  ...
  var operators = tran.children.map(function ($1) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_22__.from)(new Promise(function (resolve, reject) {
  ...
  rxjs__WEBPACK_IMPORTED_MODULE_22__.zip.apply(void 0, [root].concat(_toConsumableArray(operators))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_25__.takeLast)(1)).subscribe({
...
function _on(tran, type, callback) {
  var channelCenter = tran.channelCenter,
      errorChanel = tran.errorChanel;
  var sub = channelCenter.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_26__.filter)(function (event) {
    return isEventType(event, type) || event.type === _initParams__WEBPACK_IMPORTED_MODULE_23__.initEventKey;
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_27__.bufferCount)(2, 1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.map)(function (events) {
    return events[1];
  })).subscribe({
    complete: function complete() {
...
function _once(tran, type, callback) {
  ...
  var sub = channelCenter.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_26__.filter)(function (event) {
    ...
    return events[1];
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_29__.take)(1)).subscribe({
    complete: function complete() {
      return removeSub(tran, sub);
    },
    next: function next(event) {
...
var createRxFunc = function createRxFunc(pin, source) {
  var router = _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.router; // 只有router 可以指定在哪个pin触发

  var getDispatchPin = function getDispatchPin(route) {
    if (!!route === false) return pin;
    var isRoot = pin.id === _initParams__WEBPACK_IMPORTED_MODULE_23__.GlobalRServerKey;
    ...
    var id = (0,_initParams__WEBPACK_IMPORTED_MODULE_23__.PolySymbol)(fullPath);
    var target = _initParams__WEBPACK_IMPORTED_MODULE_23__.ServerMap.get(id);
    return target || pin;
  };
...
function createPinServer() {
  var init = function init(router) {
    router.beforeEach(function (to, from) {
      ...
      if (!_initParams__WEBPACK_IMPORTED_MODULE_23__.ServerMap.has(serve.id)) _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.children.push(serve);
      _initParams__WEBPACK_IMPORTED_MODULE_23__.ServerMap.set(serve.id, serve);
      currentServer.value = serve;
    });
    router.afterEach(function (to, from) {
      currentServer.value = getCurrentServer(to);
    });
    _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.channelCenter = new rxjs__WEBPACK_IMPORTED_MODULE_22__.BehaviorSubject(_initParams__WEBPACK_IMPORTED_MODULE_23__.initEvent);
    _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.router = router;
    _initParams__WEBPACK_IMPORTED_MODULE_23__.ServerMap.set(_initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.id, _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve);
    currentServer.value = _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve;
  };

  var Server = {
    install: function install(app) {
      init(app.config.globalProperties.$router);
      app.provide(_initParams__WEBPACK_IMPORTED_MODULE_23__.GlobalRServerKey, _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve);
      app.provide(_initParams__WEBPACK_IMPORTED_MODULE_23__.CurrentRServerKey, currentServer);

      app.config.globalProperties.$rs = function (type, data) {
        _dispatch(currentServer.value, {
          type: type,
          data: data,
          source: (0,vue_router__WEBPACK_IMPORTED_MODULE_30__.useRoute)(),
          resolve: function resolve() {},
          reject: function reject() {}
        });
      };
    },
    dispatch: function dispatch(type, data, isAsync, target) {
      var pin = undefined;
      if (!!target === false) pin = _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve;
      if (target === _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.router) pin = _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve;else {
        var router = _initParams__WEBPACK_IMPORTED_MODULE_23__.Global_Serve.router;

        var _router$resolve2 = router.resolve(target),
            fullPath = _router$resolve2.fullPath;

        var id = (0,_initParams__WEBPACK_IMPORTED_MODULE_23__.PolySymbol)(fullPath);
        pin = _initParams__WEBPACK_IMPORTED_MODULE_23__.ServerMap.get(id);
      }
      return new Promise(function (resolve, reject) {
        _dispatch(pin, {
          ...
          data: data,
          source: undefined,
          resolve: isAsync ? resolve : _initParams__WEBPACK_IMPORTED_MODULE_23__.noop,
          reject: isAsync ? reject : _initParams__WEBPACK_IMPORTED_MODULE_23__.noop
        }, !!isAsync);
...
/* harmony import */ var core_js_modules_es_json_to_string_tag_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/modules/es.json.to-string-tag.js */ "./node_modules/core-js/modules/es.json.to-string-tag.js");
/* harmony import */ var core_js_modules_es_json_to_string_tag_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_json_to_string_tag_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var core_js_modules_es_math_to_string_tag_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/modules/es.math.to-string-tag.js */ "./node_modules/core-js/modules/es.math.to-string-tag.js");
/* harmony import */ var core_js_modules_es_math_to_string_tag_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_math_to_string_tag_js__WEBPACK_IMPORTED_MODULE_5__);
...
var SHALL_CURRENT = {
  id: '',
  channelCenter: new rxjs__WEBPACK_IMPORTED_MODULE_11__.BehaviorSubject(initEvent),
  errorChanel: new rxjs__WEBPACK_IMPORTED_MODULE_11__.Subject(),
  children: [],
  clearSubs: []
};
var Global_Serve = {
...
/* harmony import */ var _initParams__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./initParams */ "./dist/initParams.js");
/* harmony import */ var _RouterPin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./RouterPin */ "./dist/RouterPin.js");
...
function useRoutePin() {
  var currentServe = (0,vue__WEBPACK_IMPORTED_MODULE_2__.inject)(_initParams__WEBPACK_IMPORTED_MODULE_0__.CurrentRServerKey);
  return (0,_RouterPin__WEBPACK_IMPORTED_MODULE_1__.createRxFunc)(currentServe, (0,vue_router__WEBPACK_IMPORTED_MODULE_3__.useRoute)());
}
/**
 *
 * @returns 全局派发
...
function useRouterPin() {
  var currentServe = (0,vue__WEBPACK_IMPORTED_MODULE_2__.inject)(_initParams__WEBPACK_IMPORTED_MODULE_0__.GlobalRServerKey);
  return (0,_RouterPin__WEBPACK_IMPORTED_MODULE_1__.createRxFunc)(currentServe, (0,vue_router__WEBPACK_IMPORTED_MODULE_3__.useRouter)());
}

function dispatchEvent(type, data, isAsync, target) {
  return _RouterPin__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch(type, data, isAsync, target);
}
...
//# sourceMappingURL=pin-dev.js.map